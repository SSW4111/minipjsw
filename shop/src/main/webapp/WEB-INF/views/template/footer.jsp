...
<!--<footer class="bg-secondary text-light py-4 mt-5">-->
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-4 mb-3">
        ...
        <ul class="list-unstyled small">
          <li><strong>회사명:</strong> KH</li>
          <li><strong>대표자:</strong> 손표재</li>
          <li><strong>동업자:</strong> 송시우</li>

          <li><strong>위치:</strong> 한국항공대역 근처</li>
        </ul>
      </div>
    ...
    <div class="text-center mt-3 small text-secondary">
      &copy; 2025 KH Company. All rights reserved.
    </div>
  </div>
</footer>
