     ...
     <script src="/js/join3.js"></script>
        ...
        <div class="row mt-4">
            <div class="col-sm-4 offset-4">
                <form action="join3" method="post" class="form-check" enctype="multipart/form-data">
                    
                    <div class="mb-3">
                    <label class="me-1 form-label" for="contact">연락처</label>
                    <input type="text" inputmode="numeric" maxlength="13" name="usersContact" placeholder="010-xxxx-xxxx" class="form-control" id="contact">
                   </div>
                    <div class="mb-3">
                    <label class="me-1 form-label" for="nickname">닉네임</label>
                    <input type="text" name="usersNickname" class="form-control " id="nickname">
                   </div>
                   <div class="mb-3 row mt-4">
                    <a  class="btn btn-secondary col-sm-3" id="profile" data-bs-toggle="modal" data-bs-target="#profileModal" href="#">프로필 등록하기<i class="fa-solid fa-plus"></i></a>
                    <button type="submit" class="btn btn-secondary col-sm-3 offset-6">회원가입 완료</button>
                   </div>
                </form>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" class="btn-close" data-bs-dismiss="modal" data-bs-target="#fileUploadModal" aria-label="Close"></button>
                </div>
